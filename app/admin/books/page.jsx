...
//     } catch (err) {
//       console.error(err);
//       alert("Tidak bisa memuat data buku. Pastikan server API berjalan.");
//     }
//   };
...
//         stock: Number.isFinite(Number(newBook.stock))
//           ? Number(newBook.stock)
//           : 1,
//       };
...
//       if (newStock < 0) return alert("Stok tidak boleh negatif");
...
//       setBooks((prev) =>
//         prev.map((b) =>
//           b.id === id ? { ...b, stock: b.stock + change } : b
//         )
//       );
//     } catch (err) {
...
//       <h1 className="text-3xl font-bold mb-8">📚 Manajemen Buku (Admin)</h1>
